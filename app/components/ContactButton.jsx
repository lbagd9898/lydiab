export default function ContactButton({ text }) {
  return (
    <a
      href="#contact"
      className="relative inline-flex items-center justify-center gap-4 bg-white border-2 border-[#1E3A5F] px-8 py-4 font-bold text-[#1E3A5F] transition-all duration-300 hover:scale-[1.02] hover:-translate-y-0.5"
