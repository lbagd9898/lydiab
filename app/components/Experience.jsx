export default function Experience({ position, company, dates, description, imageLeft }) {
  return (
    <div className="relative w-full p-6 bg-white shadow-md shadow-blue-200 transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-300">
      {imageLeft
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl font-extrabold" style={{ color: "#1E3A5F" }}>{position}</h1>
